...
<input type="hidden" name="<?php echo SN; ?>_footer_layout" id="ioa_footer_layout" value="<?php if(isset($ioa_super_options[SN."_footer_layout"])) echo get_option(SN."_footer_layout"); else echo 'four-col'; ?>" />
</div>
