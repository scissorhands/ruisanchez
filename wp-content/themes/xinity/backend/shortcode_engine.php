<?php 
global $ioa_helper,$ioa_portfolio_slug,$ioa_portfolio_name;
...
while ($query->have_posts()) : $query->the_post(); 
		...
		$w = $ioa_helper->getAssocMap($coptions,'value');
...
$ioa_shortcodes_array = array(
	...
	__("Layout Elements",'ioa') => array(
			...
			"shortcodes" => array(
					...
					"color_title" => array(
							"name" =>  __("Color Title",'ioa'),
							"syntax" => '[color_title color=""] '.__('Your Content Here..','ioa').' [/color_title]',
							"description" =>  __("This allows you to create beautiful headings",'ioa'),
							"parameters" =>  array( "color" => "color of title." )
							,"inputs" => array(

									"color" => array("type" => "colorpicker" , "label" => __("Title Color",'ioa') , 'values' => "#11d8d1" ) ,
	...
	__("UI Elements",'ioa') => array(
			...
			"shortcodes" => array(
					...
					"climate_icon" => array(
							...
							"syntax" => '[climate_icon color="#333333" width="120" height="120" type="" /]',
					...
					"button" =>array(
							...
							"syntax" => '[button size="normal" color="#fff" background="#1acad0" radius="3px" type="flat" link="" newwindow="" icon="" ]'.__('Button Label').'[/button]',
					...
					"icon" =>array(
							"name" =>  __("Icon",'ioa'),
							"syntax" => '[icon size="14px" color="#fff" background="#1acad0" radius="3px" type="" spacing="10px" /]',
	...
	__("Widgets Elements",'ioa') => array(
			...
			"shortcodes" => array(
					...
					"image" => array(
							...
							"name" =>  __("Image",'ioa'),
							"syntax" => '[image src="" resize="none" lightbox="false"  align="none" width="100%" height="250" link="" hoverbg="#1ed8ee" hoverc="#ffffff" effect="" /]',
	...
	__("Infographics",'ioa') => array(
			...
			"shortcodes" => array(
					...
					"radial_counter" => array(
							...
							"syntax" => '[radialchart width="100" font_size="72"  line_width="20" percent="70" bar_color="#555555" track_color="#eeeeee"][/radialchart]',
					...
					"progress_bar" => array(
							...
							"syntax" => '[progress_set][progress_bar unit="%" percent="95" color="#08d7c6"]95[/progress_bar][/progress_set]',
					...
					"stacked_circle_group" => array(
						"stripable" => true,
							...
							"syntax" => '[stacked_circle_group width="300" height="300"][single_circle unit="%" percent="95" background="#08d7c6" color="#ffffff" ]95[/single_circle][/stacked_circle_group]',
					...
					"doughnut_chart" => array(
						"stripable" => true,
							...
							"syntax" => '[doughnut_chart width="300" height="300"][doughnut value="25" background="#08d7c6" label="Value 1"/][/doughnut_chart]',
					...
					"pie_chart" => array(
						"stripable" => true,
							...
							"syntax" => '[pie_chart width="300" height="300"][pie value="25" background="#08d7c6" label="Value 1"/][/pie_chart]',
					...
					"polar_chart" => array(
						"stripable" => true,
							...
							"syntax" => '[polar_chart width="300" height="300"][pole value="25" background="#08d7c6" label="Value 1"/][/polar_chart]',
					...
					"bar_chart" => array(
						"stripable" => true,
							...
							"syntax" => '[bar_chart width="300" xlabels="A,B,C,D,E" height="300"][bar_set data="25,56,34,78,76" background="#08d7c6" strokecolor="#08d7c6"/][/bar_chart]',
					...
					"line_chart" => array(
						"stripable" => true,
							...
							"syntax" => '[line_chart width="300" xlabels="A,B,C,D,E" height="300"][line data="25,56,34,78,76" background="#08d7c6" strokecolor="#08d7c6" pointcolor="#08d7c6" pointstrokecolor="#08d7c6"/][/line_chart]',
