...
class IOACustomPostsManager extends IOA_PANEL_CORE {
		...
		{		
			...
			switch($type)
			{
				...
				case "update" :
					 ...
					 $ioa_helper->setPostTitle($title,$id);
					 	wp_publish_post( $id );
	...
	function panelmarkup(){	
		...
		global $ioa_custom_posts, $ioa_helper;
                	...
                	<div id="panel-wrapper" class="clearfix custompostsmanager">
						...
						<div id="cp_slides">
							...
							<?php else:  $post_id = $_GET['edit_id']; ?>
								...
								<?php 
										...
										echo $ioa_custom_posts['default']->getOptionsHTML($w,get_the_title($post_id));
							 	?>									
						...
						<div id="cp_options" class="clearfix">
									...
									if( is_array($slides ))
									 {
									 	foreach ($slides as $key => $slide) {
									 		 ...
									 		 echo $ioa_custom_posts['default']->getHTML($w);
							...
							<div class="hide">
								...
								//$w = $ioa_helper->getAssocMap($ioa_options,'value');
								echo $ioa_custom_posts['default']->getHTML();
