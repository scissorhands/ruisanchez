  ...
  class IOA_PANEL_CORE {
	  ...
	  */
	  ...
	  function manager_admin_wrap(){	
            global $ioa_page_get,$ioa_super_options;
            ?>
            ...
            <div class="panel-top-bar clearfix">
	  				<ul class="main-menu clearfix">
						...
						<?php if($ioa_super_options[SN.'_hide_installer']!='Yes') : ?>
						...
						<?php endif; ?>
	  					...
	  					<li class="clearfix <?php if($ioa_page_get=="ioaeni") echo 'active'; ?>"><a class="" href="<?php echo admin_url()."admin.php?page=ioaeni"; ?>"><?php _e('Visual Styler','ioa') ?></a></li>
	  				</ul>
