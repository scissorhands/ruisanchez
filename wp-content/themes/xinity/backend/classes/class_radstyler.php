 ...
 if(!class_exists('RADStyler'))
{
	class RADStyler
	{
		...
		function registerbgColor($key='' ,$target='')
		{
			...
			$code ='<h5 class="sub-styler-title">'.__('Set Background Color','ioa').'<i class="icon icon-caret-down"></i></h5><div class="sub-styler-section clearfix">';
		...
		function registerBorder($key='' ,$target='')
		{
			...
			$code ='<h5 class="sub-styler-title">'.__('Set Border','ioa').'<i class="icon icon-caret-down"></i></h5><div class="sub-styler-section clearfix">';
		...
		function registerbgImage($key ,$target)
		{
			...
			$code ='<h5 class="sub-styler-title">'.__('Set Background Image','ioa').'<i class="icon icon-caret-down"></i></h5><div class="sub-styler-section clearfix">';
		...
		function registerbgGradient($key ,$target)
		{
			...
			$code ='<h5 class="sub-styler-title">'.__('Set Background Gradient','ioa').'<i class="icon icon-caret-down"></i></h5><div class="sub-styler-section clearfix"><a class="set-rad-gradient button-default" href="">'.__('Apply','ioa').'</a> ';
