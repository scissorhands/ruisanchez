...
$blog_props = $ioa_meta_data['blog_props'];
 ?>
      ...
      <li itemscope itemtype='http://schema.org/BlogPosting' id="post-<?php the_ID(); ?>" class="iso-item  clearfix hover-item <?php echo join(' ',get_post_class()); ?> <?php $ioa_meta_data['i']++; if($ioa_meta_data['i']==1) echo 'first'; elseif($ioa_meta_data['i']==$ioa_meta_data['item_per_rows']) { echo 'last'; $ioa_meta_data['i']=0; } ?>">
            <div class="inner-post-wrap clearfix">   <div class="gallery  clearfix" itemprop="description" >
                    <div class="clearfix">


                        <div class="ioa-gallery seleneGallery " data-effect_type="fade" data-thumbnails="true" data-autoplay="fase" data-caption="false" data-arrow_control="false" data-duration="3000" data-height="<?php echo $ioa_meta_data['height'] ?>"  data-width="<?php echo $ioa_meta_data['width'] ?>" > 
