...
<div class="skeleton clearfix auto_align">
	<div class="mutual-content-wrap product-col-template portfolio-template iso-parent <?php if($ioa_meta_data['layout']!="full") echo 'has-sidebar has-'.$ioa_meta_data['layout'].' has-sidebar';  ?>">
		...
		<div class=" <?php echo $cl ?> hoverable no-canvas clearfix">
			<ul class="clearfix portfolio_posts effectable  isotope" itemscope itemtype="http://schema.org/ItemList"  data-layout="masonry" data-gutter="25">
				 <?php 
