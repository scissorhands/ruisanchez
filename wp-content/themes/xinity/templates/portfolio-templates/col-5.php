...
?> 
	...
	<div class="skeleton clearfix auto_align">
		<div class="mutual-content-wrap iso-parent portfolio-template <?php if($ioa_meta_data['layout']!="full") echo 'has-sidebar has-'.$ioa_meta_data['layout'].' has-sidebar';  ?>">
			...
			?>
       		...
       		<?php  
				...
				$ioa_meta_data['width'] = $ioa_layout['cols']['one_fifth']+25;
				$ioa_meta_data['height'] = $portfolio_props['_p_height'];
				if($ioa_meta_data['layout']!="full")
					$ioa_meta_data['width'] = $ioa_layout['sidebar_cols']['one_fifth']+25;

				if( $portfolio_props['portfolio_cols'] == "grid" ) $ioa_meta_data["width"] = 211;
			...
			<div class=" <?php echo $cl ?> hoverable clearfix">
				<ul class="clearfix portfolio_posts greyscale-imgs  isotope" itemscope itemtype="http://schema.org/ItemList"  data-layout="<?php if($portfolio_props['portfolio_image_resize']=='proportional') echo 'masonry'; else echo 'cellsByRow' ?>" data-gutter="<?php if( $portfolio_props['portfolio_cols'] != "grid" ) echo 25; else echo 0; ?>">
					 <?php 
