...
<div class="skeleton clearfix auto_align">
	<div class="mutual-content-wrap portfolio-template iso-parent <?php if($ioa_meta_data['layout']!="full") echo 'has-sidebar has-'.$ioa_meta_data['layout'].' has-sidebar';  ?>">
		...
		<div class="<?php if($ioa_meta_data['layout']=="full") echo 'skeleton' ?> clearfix auto_align">
   		...
   		<?php  
			...
			if($ioa_meta_data['layout']!="full")
				$ioa_meta_data['width'] = $ioa_layout['sidebar_cols']['one_half'];

			if( $portfolio_props['portfolio_cols'] == "grid" ) $ioa_meta_data["width"] = 529;
		...
		<div class=" <?php echo $cl ?> hoverable clearfix">
			<ul class="clearfix portfolio_posts effectable  isotope" itemscope itemtype="http://schema.org/ItemList"  data-layout="<?php if($portfolio_props['portfolio_image_resize']=='proportional') echo 'masonry'; else echo 'cellsByRow' ?>" data-gutter="<?php if( $portfolio_props['portfolio_cols'] != "grid" ) echo 50; else echo 0; ?>">
				 <?php 
