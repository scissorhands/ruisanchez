...
<div <?php echo join(" ",$rad_attrs) ?>>
	...
	<div class="accordion-inner-wrap">
		...
		<div class="ioa_accordion clearfix accordion-style-<?php echo $w['accordion_style']; ?>" itemscope itemtype="http://schema.org/ItemList">
  		
		
		<?php $i=0; foreach ($tabs as  $tab) {
					$ic = 'plus-2icon-';
					if($i == 0) $ic = 'minus-2icon-';

					echo ' <h3 itemprop="name" ><i class="ioa-front-icon  '.$ic.'"></i> '.stripslashes($tab['tab_title']).'</h3>';
 					echo '<div itemprop="description" class="clearfix" id="'.$tab['id'].'">'.$ioa_helper->format($tab['tab_text']).'</div>';
 					$i++;
 			} ?>
