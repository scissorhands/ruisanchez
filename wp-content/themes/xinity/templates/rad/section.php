...
$counter =  $ioa_meta_data['rad_section_counter']++;


if(strpos($ioa_meta_data['rad_section_data']['containers'],'rad_menu'))
	{
				$counter  = 99;	
				echo 'tyes';
	}
?>
<div class="page-section <?php if(isset($d['background_opts']) && $d['background_opts']=='parallax') echo 'is-parallex-bg' ?> clearfix <?php echo join(' ',$cl) ?>" style="z-index:<?php echo $counter; ?>" id='<?php echo $d['id']; ?>'>
