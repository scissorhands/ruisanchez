...
<ul class="post_masonry-container hoverable <?php echo $w['masonry_layout'] ?> isotope"  data-layout="masonry" data-gutter="0">
   ...
   <?php if($w['w_ajax'] =="yes") : ?> <a href="" class="masonry-ajax-load-more ajax-load-more-button " data-query="<?php echo base64_encode(json_encode($ioa_meta_data['widget'])) ?>">
