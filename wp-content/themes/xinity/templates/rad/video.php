...
<div <?php echo join(" ",$rad_attrs) ?>>
	<div class="video-inner-wrap" >
		...
		<?php endif; ?>
					...
					<div class="ioa-video">	
						<?php 
						echo "[video width='".$w["width"]."' height='".$w["height"]."']".trim($w['v_id'])."[/video]";
					 	?>
				<?php if(isset($w['text_caption']) && $w['text_caption']!="" ) : ?><h4  class=" text_caption custom-font1"><?php echo $ioa_helper->format($w['text_caption'],true,false,false); ?></h4><?php endif; ?>
				</div>
