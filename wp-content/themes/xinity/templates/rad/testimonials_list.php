...
<div <?php echo join(" ",$rad_attrs) ?>>
  <div class="testimonials-list-inner-wrap" >
  ...
  <?php if(isset($w['text_title']) && $w['text_title']!="") : ?>
    ...
    <div class="updatable">
        <ul class="rad-testimonials-list-alt clearfix <?php if(isset($w['t_style']) ) echo $w['t_style'];  ?>"   itemscope itemtype="http://schema.org/Review">          
