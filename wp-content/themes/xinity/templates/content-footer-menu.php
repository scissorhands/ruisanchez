...
global $ioa_super_options,$ioa_helper;     

?>

 <?php  if( $ioa_super_options[SN."_footer_menu"]=="Yes") : ?>
<div id="footer-menu">
    <div  class=" clearfix  skeleton auto_align "  itemscope itemtype='http://schema.org/SiteNavigationElement'>
   
             <p class="footer-text">  <?php echo $ioa_helper->format($ioa_super_options[SN."_footer_text"],false,false,false); ?> </p> 
