...
if(isset( $ioa_options['dominant_color'] )) $dc = $ioa_options['dominant_color'];
  ...
  switch ($format_type) {
    ...
    case 'gallery':get_template_part("templates/blog-formats/post-gallery_alt"); break;  
    ...
    default: ?>
      ...
      <li itemscope itemtype="http://schema.org/Article"  id="post-<?php the_ID(); ?>"  class="iso-item hover-item clearfix <?php echo join(' ',get_post_class()); ?>  <?php $ioa_meta_data['i']++; if($ioa_meta_data['i']==1) echo 'first'; elseif($ioa_meta_data['i']==$ioa_meta_data['item_per_rows']) { echo 'last'; $ioa_meta_data['i']=0; } ?>">
            ...
            if(is_sticky()) echo '<i class="pin-2icon- ioa-front-icon sticky-icon post-icon"></i>';
             ...
             ?>
              ...
              switch($mt)
              {
                ...
                case "image" : 
                default : $image = URL."/sprites/i/dummy.png"; ?>
