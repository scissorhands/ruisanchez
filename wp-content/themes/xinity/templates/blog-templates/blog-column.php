...
if(! post_password_required())  // Check if Page is password protected
	...
	<div class="skeleton clearfix auto_align">
		...
		<div class="mutual-content-wrap blog-template iso-parent <?php if($ioa_meta_data['layout']!="full") echo 'has-sidebar has-'.$ioa_meta_data['layout'];  ?>" itemscope itemtype="http://schema.org/Blog">
