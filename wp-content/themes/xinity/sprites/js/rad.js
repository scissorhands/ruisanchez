                  ...
                  */
                  ...
                  temp.find('.rad_page_container').each(function(k){
                          ...
                          ctemp.find('.rad_page_widget').each(function(l){
                                                    ...
                                                    widget_str  += "[rad_page_widget id='"+jQuery(this).attr('id')+"'  type='"+jQuery(this).data('key')+"'  layout='"+jQuery(this).find('.widget_layout').val()+"'  ";
...
=====================================*/
  ...
  {
    jQuery.post(saving_link,{ type:"rad-builder-data", action: 'ioalistener' },function(data){
  ...
  temp = jQuery(this).parents('.rad_page_section');
     ...
     temp.find('.rad_page_container').each(function(k){
      ...
      save_array[0] = { id : temp.attr('id') , data  : d , containers : conts  };
       ...
       jQuery.post(
          saving_link,{ type:"RAD-Template-Export", action: 'ioalistener' , data : JSON.stringify(save_array)  , id : frame.data('id') ,title : jQuery(this).prev().val() },function(data){
...
doc.on('change','.widget_layout',function(){
...
jQuery('.export-templates').click(function(e){
  ...
  save_array = [];
   ...
   jQuery.post(saving_link,{ type:"RAD-Template-Export", action: 'ioalistener' , data : RAD_Builder.saveRADData(frame)  , id : frame.data('id') ,title : jQuery('#title').val() },function(data){
...
jQuery('.insta-template-trigger').click(function(){
    ...
    jQuery('.rad-library-lightbox-head').html('Importing Please wait...');
     ...
     jQuery.post(saving_link,{ type:"RAD-InstaImport", action: 'ioalistener' , key : jQuery(this).data('source') },function(data){
...
jQuery('.insta-section-template-trigger').click(function(){
   ...
   jQuery.post(saving_link,{ type:"RAD-InstaImport-Section", action: 'ioalistener' , key : jQuery(this).data('source') },function(data){
...
jQuery('.rev-thumb').click(function(){
      ...
      jQuery.post(saving_link,{ type:"RAD-Revision-Import", action: 'ioalistener', post_id : frame.data('id') , key : jQuery(this).data('id') },function(data){
...
jQuery('.save-revision').click(function(e){
   ...
   jQuery.post(saving_link,{ type:"RAD-Revision", action: 'ioalistener' , data : RAD_Builder.saveRADData(frame)  , id : frame.data('id') ,title : auto_title },function(data){
...
jQuery('.import-rad-page').click(function(e){
    ...
    jQuery.post(saving_link,{ type:"RAD-Page-Import", action: 'ioalistener' , data : jQuery('.import_rad_page').val()   },function(data){
...
jQuery('.import-s-template').click(function(e){
    e.preventDefault();
     ...
     jQuery.post(saving_link,{ type:"RAD-Import-Section", action: 'ioalistener' , key : jQuery(this).data('key') },function(data){
...
jQuery('.import-s-template i.delete-icon').click(function(e){
    ...
    temp = jQuery(this).parent();
     jQuery.post(saving_link,{ type:"RAD-Section-Delete", action: 'ioalistener' , key : temp.data('key') },function(data){
...
jQuery('.import-p-template').click(function(e){
    e.preventDefault();
     ...
     jQuery.post(saving_link,{ type:"RAD-Import", action: 'ioalistener' , key : jQuery(this).data('key') },function(data){
...
jQuery('.import-p-template i.delete-icon').click(function(e){
    ...
    e.stopImmediatePropagation();
    temp = jQuery(this).parent();
     jQuery.post(saving_link,{ type:"RAD-Template-Delete", action: 'ioalistener' , key : temp.data('key') },function(data){
